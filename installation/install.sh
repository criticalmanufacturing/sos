...
# This can be obtained using "curl -OL https://github.com/criticalmanufacturing/sos/raw/refs/heads/main/installation/install.sh" and then "sudo bash install.sh".

echo "Removing any existing cmf-sos installation..."
rm -f /usr/local/bin/cmf-sos

echo "Installing cmf-sos and its dependencies..."
curl -OL https://github.com/criticalmanufacturing/sos/releases/download/v1.0.0/cmf-sos
